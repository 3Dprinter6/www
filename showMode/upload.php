...
if (isset($_POST["name"]) && isset($_POST["introduction"] )){
	...
	$sql= "INSERT INTO platform(  `pictureNo` , `pictureName` ,  `3dimageLink` ,  `2dimageLink` ,  `physicalImage` ,  `productInfo` ,  `Score` ,  ` Hitrate`  ,`memberNo` , `categoryNo`)  VALUES ('','$arr[0]',  '$file[0]',  '$file[1]',  '$file[2]',  '$arr[3]',  '0',  '0' , '6' , '$arr[1]')";
